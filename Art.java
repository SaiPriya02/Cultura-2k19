...
public class Art extends MainActivity implements Art_Adapter.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        aAdapter = new Art_Adapter(artList, this);
        aRecyclerView.setLayoutManager(aLayoutManager);
        aRecyclerView.setAdapter(aAdapter);

       /* aAdapter.setOnItemClickListener(new Art_Adapter.OnItemClickListener() {
            @Override
            public void onItemClick(int position) { //its either this or the method that's outside
    ...
    public void onItemClick(int position) {
        ...
        //for the above thingy to work, it has to be parseable, whatever that means - look it up
        startActivity(intent);
    }
}