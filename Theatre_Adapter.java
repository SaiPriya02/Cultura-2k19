...
public class Theatre_Adapter extends RecyclerView.Adapter<Theatre_Adapter.TheatreViewHolder> {
    ...
    public static class TheatreViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{

        public TextView thtextView;
        OnItemClickListener listener;

        public TheatreViewHolder(@NonNull View itemView, OnItemClickListener listener) {
            super(itemView);
    ...
    public Theatre_Adapter(ArrayList<TheatreItem> theatreList, OnItemClickListener listener) {
